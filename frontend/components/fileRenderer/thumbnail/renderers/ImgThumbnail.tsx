...
export default function ImgThumbnail({ resource, url }: ImageThumbnailProps) {
    return (
        <Link
            className="bg-surface rounded-lg p-lg col-span-4 inline-block border-1 border-surface hover:border-text-tertiary min-h-90 m-sm"
        ...
        >
            <div className="flex flex-col gap-md">
                ...
                <p className="text-sm text-text-secondary line-clamp-1">{resource.description}</p>
